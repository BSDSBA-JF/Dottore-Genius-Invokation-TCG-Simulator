...
class TestTartaglia(unittest.TestCase):
    ...
    def test_normal_attack(self):
        ...
        self.assertNotIn(RiptideStatus, p2ac.character_statuses)

        # test charged attack applies RiptideStatus
        game_state = step_skill(game_state, Pid.P1, CharacterSkill.SKILL1)
        p2ac = game_state.player2.just_get_active_character()
        self.assertIn(RiptideStatus, p2ac.character_statuses)
    ...
    def test_skill2(self):
        ...
        self.assertNotIn(RangeStanceStatus, p1ac.character_statuses)
        self.assertIn(MeleeStanceStatus, p1ac.character_statuses)
        self.assertIn(RiptideStatus, p2ac.character_statuses)
        dmg = get_dmg_listener_data(game_state, Pid.P1)[-1]
        self.assertEqual(dmg.damage, 2)
    ...
    def test_elemental_burst(self):
        ...
        assert RangeStanceStatus in p1_active_char(base_state).character_statuses
    ...
    def test_melee_stance_status(self):
        ...
        assert RiptideStatus not in p2_active_char(base_state).character_statuses
        ...
        self.assertEqual(dmg.damage, 2)
        self.assertIs(dmg.element, Element.HYDRO)
        assert RiptideStatus in p2_active_char(game_state).character_statuses
        ...
        self.assertNotIn(MeleeStanceStatus, p1ac.character_statuses)
        self.assertIn(RangeStanceStatus, p1ac.character_statuses)
