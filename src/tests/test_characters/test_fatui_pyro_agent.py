...
class TestFatuiPyroAgent(unittest.TestCase):
    ...
    assert type(BASE_GAME.player1.just_get_active_character()) is FatuiPyroAgent
    ...
    def test_passive(self):
        p1ac = self.BASE_GAME.player1.just_get_active_character()
        self.assertIn(StealthStatus, p1ac.character_statuses)
        self.assertEqual(p1ac.character_statuses.just_find(StealthStatus).usages, 2)
    ...
    def test_stealth_status(self):
        ...
        self.assertFalse(p2ac.elemental_aura.has_aura())
        self.assertEqual(p1ac.character_statuses.just_find(StealthStatus).usages, 1)
    ...
    def test_talent_card(self):
        ...
        self.assertEqual(p2ac.hp, 8)
        self.assertIn(Element.PYRO, p2ac.elemental_aura)
        self.assertEqual(p1ac.character_statuses.just_find(StealthStatus).usages, 3)
